...
const GEMINI_KEY = "YAHAN_APNI_KEY_LAGAO";
...
[{"name":"Game Name","genre":"Genre","size":"XX MB","rating":"4.5","description":"One line","minRam":"1GB"}]`;
  ...
  return (
    <div style={{ minHeight:"100vh", background:dark, color:"#e0e0ff", fontFamily:"'Segoe UI',sans-serif", padding:"0", overflowX:"hidden" }}>
      ...
      <div style={{ position:"relative", zIndex:1, maxWidth:"860px", margin:"0 auto", padding:"32px 16px" }}>
        ...
        <div style={{ marginBottom:"24px", position:"relative" }}>
          <input type="text" placeholder='Search: "top games under 100mb" ya "offline RPG"'
        ...
        {results&&(
          <div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))", gap:"16px" }}>
              {results.map((game,i)=>(
                <div key={i} style={{ background:card, border:"1px solid #ffffff0f", borderRadius:"16px", padding:"20px", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ textAlign:"center", marginTop:"48px", color:"#333355", fontSize:"11px" }}>
          GameFinderAI © 2026 • Powered by Gemini AI
        </div>
      </div>
    </div>
  );
